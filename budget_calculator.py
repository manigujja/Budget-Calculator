...
def budget_status(budget, spent):
    ...
    percrntage = (remaining / budget) * 100
    ...
    print(f"Remaining percentage is : {percrntage:.2f}%")
...
def can_buy(item_price, remaining):
    ...
    # item price must be positive and within the remaining budget
    ...
    while keppr_going:
        ...
        if choice == 1:
            ...
            if can_buy(item_price, remaining):
                ...
                conformation = input(f"Buy {item_name} for ${item_price:.2f}? (yes/no): ")
                ...
                if conformation.lower() == "yes":
                    ...
                    print(f"{item_name} Conformed the purchases.")

                else:

                    print(f"{item_name} Cancelled the purchases.")

            else:

                print(f"Cannot buy {item_name}. Not enough budget remaining.")

                print(f"you are short of ${item_price - remaining:.2f} to buy {item_name}.")
            ...
            # after exiting inner loop, evaluate purchase
            ...
            if item_count == 0:
                ...
                print(f"\nCart ready: {item_count} items, Total: ${cart_total:.2f}")
                ...
                if affordable:
                    ...
                    print(f"You are short of ${cart_total - remaining:.2f} to complete the purchase.")

                    if not reasonable:

                        print("This purchase is also not reasonable based on your remaining budget.")
